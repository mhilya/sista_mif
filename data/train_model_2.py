...
CORPUS_FILE = BASE_DIR / "processed" / "training_corpus_2.csv"
...
def main():
    ...
    if not CORPUS_FILE.exists():
        print("training_corpus_2.csv not found")
        return
    ...
    test_path = BASE_DIR / "processed" / "test_set_internal_2.csv"
    if test_path.exists():
        ...
        print("\n⚠️  test_set_internal_2.csv tidak ditemukan. Jalankan prepare_corpus.py terlebih dahulu.\n")
